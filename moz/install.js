...
var XpiInstaller = {
	...
	extFullName: 'Joule', // The name displayed to the user (don't include the version)
	extShortName: 'joule', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Thomas Thurman',
